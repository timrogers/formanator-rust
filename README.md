...
2. Fill in one row per claim. You can leave `benefit` and `category` blank if you've configured an LLM. Comma-separate paths in the `receiptPath` column to attach multiple receipts.
